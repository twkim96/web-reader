...
export const ShelfHeader: React.FC<ShelfHeaderProps> = ({
  ...
  const dockClass = `flex h-[4.125rem] items-center rounded-full ${dockSurfaceClass} gap-0.5 px-1.5 shadow-[0_18px_55px_rgba(0,0,0,0.18)] lg:gap-1.5 lg:px-2`;
  const bottomDockClass = `flex h-[4.25rem] w-[calc(100vw-1rem)] max-w-sm items-center justify-center rounded-full ${dockSurfaceClass} px-1 shadow-[0_18px_55px_rgba(0,0,0,0.28)] md:h-[4.5rem] md:w-auto md:max-w-[calc(100vw-1rem)] md:px-3`;
