...
export const ShelfHeader: React.FC<ShelfHeaderProps> = ({
  ...
  const bottomDockClass = `relative flex h-[4.25rem] w-[calc(100vw-4.75rem)] max-w-xs items-center justify-center rounded-[34px] ${standardDock ? 'shadow-[0_18px_55px_rgba(0,0,0,0.28)]' : ''} ${dockSurfaceClass} px-1 md:h-[4.5rem] md:w-auto md:max-w-[calc(100vw-1rem)] md:px-3`;
