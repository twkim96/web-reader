...
| 1.8.22 | iPad hidden iframe rAF throttle 제거 | reader-font/section-end/stable pagination의 staging frame을 visible host renderer로 이동 | 중상 | 구현·전체 `npm run check`·집중 Chromium/WebKit 8건 완료, iPad 동일 긴 section 재검증 대기 |
