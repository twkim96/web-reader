...
| 1.8.20 | iPad EPUB cold-open 계측·pre-view 안정화 | IDB/ZIP/EPUB/font/section 단계 timing·진단 export·`#view.element` pre-view 방어 | 중상 | 구현·전체 `npm run check`·집중 Chromium/WebKit 6건 완료, iPad 느린/빠른 section 진단 JSON 및 cloud first-open 재검증 대기 |
