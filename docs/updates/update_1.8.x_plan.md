...
전체 상태: 1.8.12 동기화 안정화 코드와 전체 자동검증을 완료했다. 전체 동기화 리뷰와 도서 오픈 시 경합 리뷰를 한 버전에 묶어 canonical bookmark 수신, adoption-first remote resume, 초기 pagination, lifecycle reconciliation을 보강했으며 외부 재리뷰·실기기 확인을 기다린다.
