...
| 1.8.35 | 로그인·Drive 연결 수명주기 안정화 | 로그아웃 무탐색 전환·Drive OAuth state의 세션/동일 출처 fallback·일회 소비·TTL 검증 | 높음 | **개발 완료 · 실사용 확인 대기** · Drive 56건·shelf 121건·release 3건·전체 `npm run check` 통과, 실제 계정 첫 Drive 연결 확인 대기 |
