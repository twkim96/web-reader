...
전체 상태: 1.8.3 hotfix.1·hotfix.2 누적 커밋 완료. 1.8.4 코드·전체 자동검증 완료, 외부 리뷰와 누적 실기기 검증 대기
...
| 1.8.4 | 라이브러리 전체 주석 검색·내보내기 | 대량 조회·파일 저장·공유 | 중간 | 코드·전체 자동검증 완료, 외부 리뷰·실기기 검증 대기 |
...
상태: 코드·전체 자동검증 완료, 외부 리뷰·실기기 검증 대기 — 세부 실행 문서 `update_1.8.4.md`
