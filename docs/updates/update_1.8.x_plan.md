...
전체 상태: 1.8.3 hotfix.1·hotfix.2 누적 커밋 완료. 1.8.4 외부 리뷰 후 hotfix.1 코드·전체 자동검증 완료, 커밋과 누적 실기기 검증 대기
...
| 1.8.4-hotfix.1 | 동기화 충돌·대량 주석 안정화 | reset·revision chain·멱등성·hidden modal | 높음 | 코드·전체 자동검증 완료, 커밋·실기기 검증 대기 |
