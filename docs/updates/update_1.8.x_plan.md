...
| 1.8.34 | 메뉴 모달·모바일 바텀시트 통일 | Shelf/Reader 메뉴 모달 공통 헤더·모바일 하단 시트·PC 테마 표면·기존 작업 대화상자 배치 보존 | 중간 | **완료** · `npm run check`·shelf UI 41건·release 3건 통과, production browser는 기존 PNG clipboard fixture timeout |
