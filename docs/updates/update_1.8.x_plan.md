...
| 1.8.21 | iPad RIDIBatang stabilization 세부 계측 | iframe `fonts.load`·frame·expand·content/root rect timing 분리 | 중간 | 구현·전체 `npm run check`·집중 Chromium/WebKit 4건 완료, iPad 진단 JSON 재수집 대기 |
